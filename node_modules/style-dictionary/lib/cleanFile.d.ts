 ...
 * @param {Volume} [vol]
 */
export default function cleanFile(file: File, platform?: import("../types/Config.d.ts").PlatformConfig | undefined, vol?: import("../types/Volume.d.ts").Volume | undefined): Promise<void>;
