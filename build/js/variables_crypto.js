...
export const colorBaseViolet243 = "#9D3ADF";
export const colorBaseBlue266 = "#106AB6";
export const colorMainPrimary = "#9D3ADF"; // Primary Brand Color
...
export const fontFamilyPrimary = "Nunito"; // Crypto font
